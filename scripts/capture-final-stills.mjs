...
if (artifactSet.schema !== "pf07.artifact-set-manifest.v1"
  || artifactSet.package_version !== "1.0.6"
...
await writeGuide({
  id: "GUIDE-001", slug: "windows-download-start", language: "ko", eyebrow: "WINDOWS BUYER PACKAGE / 1.0.6",
...
await writeGuide({
  id: "GUIDE-001", slug: "windows-download-start", language: "en", eyebrow: "WINDOWS BUYER PACKAGE / 1.0.6",
...
await writeGuide({
  id: "GUIDE-002", slug: "windows-preflight-evidence", language: "ko", eyebrow: "WINDOWS KVM TEST KIT / 1.0.6",
...
await writeGuide({
  id: "GUIDE-002", slug: "windows-preflight-evidence", language: "en", eyebrow: "WINDOWS KVM TEST KIT / 1.0.6",
...
await writeGuide({
  id: "GUIDE-003", slug: "macos-download-first-launch", language: "ko", eyebrow: "macOS UNIVERSAL PACKAGE / 1.0.6",
...
await writeGuide({
  id: "GUIDE-003", slug: "macos-download-first-launch", language: "en", eyebrow: "macOS UNIVERSAL PACKAGE / 1.0.6",
